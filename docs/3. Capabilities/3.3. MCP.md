...
- You can name the MCP protocol revision this course speaks, the file that caps the client below the next one, and the three client capabilities this course deliberately does not declare.
