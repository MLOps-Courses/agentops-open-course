...
!!! abstract "In one glance"
    ...
    - **You need:** [3.0. Packaging](./3.0.%20Packaging.md) finished, `uv run pytest` working inside `agents/python`, and `cd agents/python && mise run config:check` passing for the tool-call checkpoint.
