---
description: "Build the locked non-root agent image as a digest-pinned multi-stage Dockerfile, understand why one image serves three roles, scan the exact artifact, and verify its release signature and SBOM."
---
