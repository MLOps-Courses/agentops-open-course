...
The cloud lab is optional and billable. At prices checked on 31 July 2026, fixed resources cost about USD 28.25 monthly when the billing account's GKE, disk, and registry allowances remain available. The same resources cost up to about USD 29.49 when only the GKE credit remains. This page owns those figures; [6.6. Platform Delivery](../6.%20Platform/6.6.%20Platform%20Delivery.md), which plans the lab, links here instead of restating them.
...
??? note "Deeper: what the GKE lab provisions, and what it costs"
    ...
    The two images total about 0.43 GiB. They fit inside Artifact Registry's 0.5 GiB free allowance, or cost about USD 0.04 monthly if another project has consumed it.

    With every allowance available, fixed resources total about USD 28.25 before variable GCS, network, and Vertex use. With only the GKE credit, they cost up to about USD 29.49. Without that credit, add USD 73 for a 730-hour month: about USD 101.25 to USD 102.49.
