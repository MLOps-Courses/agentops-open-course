...
The course repository is public at [MLOps-Courses/agentops-open-course](https://github.com/MLOps-Courses/agentops-open-course):

- Use course issues for reproducible defects and scoped improvements.
- Read `CONTRIBUTING.md` before opening a pull request.
- Report vulnerabilities through the private process in `SECURITY.md`, never a public issue.
