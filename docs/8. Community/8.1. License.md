...
Splitting them keeps each grant clean: reusing a paragraph of the course and forking the Go agent have clear, separate rules, and neither accidentally imposes the other's terms.
