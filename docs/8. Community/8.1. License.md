...
- **The code** (`agents/`, `infra/`) is licensed under the [MIT License](https://opensource.org/license/mit), in [`agents/LICENSE`](https://github.com/MLOps-Courses/agentops-open-course/blob/main/agents/LICENSE) and [`infra/LICENSE`](https://github.com/MLOps-Courses/agentops-open-course/blob/main/infra/LICENSE).
