...
A **judge** is a second model asked to grade the agent's answer. It stays optional during Chapter 4. After the default host gateway from [5.1. Gateway Setup](../5.%20Gateway/5.1.%20Gateway%20Setup.md) is running, opt in with an explicit route:
